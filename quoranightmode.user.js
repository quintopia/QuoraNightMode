...
(function() {
    ...
    if (hr<6||hr>=21) {
        GM_addStyle('\
                    ...
                    .body.feed_card_on div{\
                    background-color: #111111 !important;\
                    }\
                    body.feed_card_on .AmaSelfServeQuestions{\
                    background-color: #111111 !important;\
                    }\
                    body.feed_card_on .system_a2a_feed{\
                    background-color: #111111 !important;\
                    }\
                    ...
                    body.feed_card_on .Bundle .full_bundle{\
                    background-color: #111111 !important;\
                    }\
                    ...
                    body.feed_card_on .QuestionsForNewWritersList .feed_item, body.feed_card_on .HipriHumanA2ARequestsList .feed_item, body.feed_card_on .LowpriHumanA2ARequestsList .feed_item, body.feed_card_on .WritingListMain .WritingList.PagedList .feed_item {\
                    background-color:#111111 !important;\
                    }\
                    body.feed_card_on .AmaSelfServeQuestionsPrompt {\
                    background-color: #111111 !important;\
                    }\
                    ...
                    body.feed_card_on .BoardDraftsAndDraftsList .draft_item {\
                    background-color: #111111 !important;\
                    }\
                    ...
                    *:not(.linenums) > *:not(.selected) > span {\
                    ...
                    .AskerSatisfactionSurvey {\
                    box-shadow: 2px 3px 2px #111 !important;\
                    }\
                    .AnswerSurvey {\
                    background-color: #222 !important;\
                    border: 1px solid #111 !important;\
                    }\
                    .AnswerSurvey .title_text {\
                    color: #fff !important;\
                    }\
                    .AnswerSurvey .question_wrapper .button_group .survey_button {\
                    background: #151515 !important;\
                    }\
                    .Bundle .view_all_button_prominent:hover {\
                    background: #222222 !important;\
                    }\
                    .HyperLinkPreview .hyperlink_description {\
                    color: #999 !important;\
